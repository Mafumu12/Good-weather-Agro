<template>
  ...
  <form @submit.prevent="searchCity">
    ...
    <div class="relative">
      ...
      <input v-model="form.city" type="text" class="block w-full p-4 ps-10 text-sm text-gray-900  rounded-lg bg-[#0654B0]     
    " placeholder="Search for any city " required />
      <button type="submit"
        class="text-white absolute end-2.5 bottom-2.5 bg-[#F6CF67]  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2  ">search</button>
