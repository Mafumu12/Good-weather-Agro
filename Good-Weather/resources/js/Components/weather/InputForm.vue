<template>
  ...
  <div class="block  w-full p-6 bg-[#080A32] mt-2    rounded-lg  ">
    ...
    " placeholder="Search for any city " required />
        <button type="submit"
          class="text-white absolute end-2.5 bottom-2.5 bg-[#106D15]  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2  ">search</button>
